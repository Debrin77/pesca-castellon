...
const cordoba = read("src/provincias/cordoba/config.ts");
if (!cordoba.includes("continentalOnly: true")) {
  fail("Córdoba debe ser continentalOnly");
}
if (!cordoba.includes("speciesExtra") || !cordoba.includes("speciesOverrides")) {
