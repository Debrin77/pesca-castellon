...
const styles = StyleSheet.create({
  ...
  chipTipo: { fontSize: 12, fontWeight: "800", color: COLORS.textMuted, letterSpacing: 0.5 },
  chipTipoGlass: { color: "rgba(255,255,255,0.75)" },
  chipHora: { fontSize: 15, fontWeight: "800", color: COLORS.textPrimary, marginTop: 2 },
  chipLabel: { fontSize: 12, color: COLORS.textSecondary, marginTop: 2 },
  mareaBox: { marginTop: 12 },
  meta: { fontSize: 13, color: COLORS.waterDark, fontWeight: "600", marginTop: 4 },
  metaGlass: { color: "#dff3ff", fontWeight: "700" },
  oleaje: { fontSize: 13, color: COLORS.textSecondary, marginTop: 8 },
  disclaimer: { fontSize: 12, color: COLORS.textMuted, marginTop: 10, fontStyle: "italic" },
});
