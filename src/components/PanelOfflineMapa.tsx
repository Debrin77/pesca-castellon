  ...
  return (
    <View style={styles.box} accessibilityLabel={`Mapa offline · ${nombre}`}>
      ...
      <Text style={styles.sub}>
        {provinciaCtx && !provinciaCtx.continentalOnly
          ? `Calienta teselas de ${nombre} en caché (también costa y rampas). Normativa y especies de esta provincia ya van en la app.`
