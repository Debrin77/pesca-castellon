...
const styles = StyleSheet.create({
  ...
  meta: { fontSize: 12, color: COLORS.textSecondary, marginTop: 4, marginBottom: 8 },
  claveKicker: {
    fontSize: 12,
    fontWeight: "800",
  ...
  ok: { fontSize: 13, color: COLORS.textSecondary, lineHeight: 18, marginBottom: 4 },
  warn: { fontSize: 13, color: COLORS.danger, lineHeight: 18, marginBottom: 4, fontWeight: "600" },
  especies: { fontSize: 13, marginTop: 6, fontWeight: "600" },
  fuenteBox: { marginTop: 10, paddingTop: 8, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: COLORS.border },
  fuenteKicker: { fontSize: 12, fontWeight: "800", color: COLORS.textMuted, letterSpacing: 0.4, marginBottom: 2 },
  fuente: { fontSize: 12, color: COLORS.textSecondary, marginTop: 4, fontStyle: "italic" },
  link: { fontSize: 13, fontWeight: "700", marginTop: 6 },
  permisoBox: {
    marginTop: 8,
    marginBottom: 4,
    padding: 10,
  ...
  permisoTitle: { fontSize: 13, fontWeight: "800", color: COLORS.warning, marginBottom: 4 },
  coberturaBox: {
    marginTop: 8,
    marginBottom: 4,
    padding: 10,
  ...
  coberturaTitle: { fontSize: 13, fontWeight: "800", color: COLORS.textPrimary, marginBottom: 4 },
  ...
  btnDetalleTxt: { fontSize: 14, fontWeight: "800" },
  compactoRow: {
    borderLeftWidth: 4,
    paddingLeft: 10,
    paddingVertical: 2,
