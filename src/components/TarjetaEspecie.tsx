...
const styles = StyleSheet.create({
  ...
  tallaPie: { fontSize: 13, color: COLORS.textSecondary, marginTop: 2, lineHeight: 16 },
  cardTitle: { fontSize: 18, fontWeight: "800", color: COLORS.textPrimary, letterSpacing: -0.3, paddingHorizontal: 16 },
  cardNote: { fontSize: 13, color: COLORS.textSecondary, marginTop: 3, fontStyle: "italic", paddingHorizontal: 16 },
  ...
  avisoLegalText: { fontSize: 14, color: COLORS.textSecondary, lineHeight: 19, fontWeight: "600", paddingHorizontal: 16 },
  cardStatus: { fontSize: 14, color: COLORS.textSecondary, marginTop: 8, lineHeight: 20, paddingHorizontal: 16 },
  badgeInvasora: { fontSize: 12, color: COLORS.warning, fontWeight: "800" },
