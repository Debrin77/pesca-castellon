...
const styles = StyleSheet.create({
  ...
  cargandoTxt: { fontSize: 13, color: COLORS.textSecondary, fontWeight: "600" },
  ...
  ctaSub: { color: "rgba(255,255,255,0.92)", fontSize: 14, marginTop: 4, lineHeight: 18 },
  ...
  sub: { fontSize: 14, color: COLORS.textSecondary, marginTop: 4, lineHeight: 18 },
  nota: {
    marginTop: 8,
    fontSize: 14,
    fontStyle: "italic",
