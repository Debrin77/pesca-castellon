...
const styles = StyleSheet.create({
  ...
  sub: { fontSize: 13, color: COLORS.textSecondary, marginTop: 4, marginBottom: 12, lineHeight: 17 },
  ...
  trioMeta: { fontSize: 12, color: COLORS.textSecondary, marginTop: 4, lineHeight: 14 },
  trioLink: { paddingTop: 8, color: COLORS.waterDark, fontWeight: "800", fontSize: 13 },
  ...
  atajoTxt: { fontSize: 13, fontWeight: "800", color: COLORS.waterDark },
  masBtn: {
    marginTop: 12,
    paddingVertical: 10,
    alignItems: "center",
  ...
  masBtnTxt: { fontSize: 14, fontWeight: "800", color: COLORS.primary },
  masBox: { marginTop: 10 },
  card: {
    backgroundColor: COLORS.mist,
    borderRadius: RADIUS.md,
  ...
  cardBody: { fontSize: 13, color: COLORS.textSecondary, marginTop: 4, lineHeight: 17 },
  cardMeta: { fontSize: 12, color: COLORS.textMuted, marginTop: 4, lineHeight: 16 },
  linkBtn: { marginTop: 8 },
  linkTxt: { color: COLORS.waterDark, fontWeight: "800", fontSize: 14, marginTop: 8 },
  linkTxtInline: { color: COLORS.waterDark, fontWeight: "800", fontSize: 14 },
});
