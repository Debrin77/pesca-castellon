...
const styles = StyleSheet.create({
  ...
  label: { fontSize: 12, fontWeight: "800", color: COLORS.textMuted, marginTop: 6, marginBottom: 4 },
  ...
  toggleText: { fontWeight: "700", color: COLORS.textPrimary, fontSize: 14 },
  ...
  candName: { fontWeight: "800", color: COLORS.textPrimary, fontSize: 14 },
  candMotivos: { fontSize: 12, color: COLORS.textSecondary, marginTop: 2 },
});
