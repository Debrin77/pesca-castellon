...
const styles = StyleSheet.create({
  ...
  lead: { fontSize: 14, color: COLORS.textSecondary, lineHeight: 18, marginBottom: 10 },
  tituloOk: { fontSize: 14.5, fontWeight: "800", color: COLORS.primaryDark, marginBottom: 4 },
  meta: { fontSize: 13, color: COLORS.textSecondary, lineHeight: 17 },
  card: {
    borderLeftWidth: 5,
  ...
  tipo: { fontSize: 13, fontWeight: "700", color: COLORS.textSecondary },
  titulo: { fontSize: 15, fontWeight: "800", color: COLORS.textPrimary },
  zona: { fontSize: 13, color: COLORS.textSecondary, marginTop: 2, fontWeight: "600" },
  detalle: { fontSize: 14, color: COLORS.textPrimary, lineHeight: 18, marginTop: 6 },
  cuando: { fontSize: 12, color: COLORS.textSecondary, marginTop: 6 },
  fuente: { fontSize: 12, color: COLORS.textSecondary, marginTop: 4, fontStyle: "italic" },
  link: { marginTop: 8, fontSize: 14, fontWeight: "700", color: COLORS.waterDark },
});
