...
const styles = StyleSheet.create({
  ...
  cuando: { fontSize: 11.5, color: COLORS.textSecondary, marginTop: 6 },
  fuente: { fontSize: 11, color: COLORS.textSecondary, marginTop: 4, fontStyle: "italic" },
  link: { marginTop: 8, fontSize: 13, fontWeight: "700", color: COLORS.waterDark },
});
