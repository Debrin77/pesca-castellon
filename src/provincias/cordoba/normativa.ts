/**
 * Marco normativo oficial de pesca continental en Andalucía (Córdoba).
 * Misma Orden BOJA que Sevilla; cartografía DERA filtrada por provincia.
 *
...
export const REGLAS_GENERALES_ANDALUCIA = [
  ...
  "Aguas libres (art. 5.2): toda masa no delimitada como coto o refugio. En Córdoba los embalses listados son libres salvo refugios del Anexo IV.",
