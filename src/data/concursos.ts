...
export const CONCURSOS: ConcursoPesca[] = [
  ...
  {
    id: "co-portal-delegacion",
    titulo: "Delegación Córdoba · convocatorias e inscripción",
    fecha: "2026-01-01",
    fin: "2026-12-31",
    lugar: "Córdoba",
    modalidad: "Provinciales / clubes",
    organizador: "FAPD Córdoba",
    provinciaId: "cordoba",
    url: "https://fapd.org/",
    notas: "Boletines, bases y plazos en cada convocatoria. Apúntate por tu club. Confirma sede provincial en FAPD.",
    cta: "Abrir FAPD",
    portal: true,
  },
  {
    id: "co-portal-clubes",
    titulo: "Clubes de pesca · FAPD Andalucía",
    fecha: "2026-01-01",
    fin: "2026-12-31",
    lugar: "Córdoba y Andalucía",
    modalidad: "Clubes",
    organizador: "FAPD",
    provinciaId: "cordoba",
    url: "https://fapd.org/",
    notas: "Lista de clubes para federarte e inscribirte en concursos (consulta delegación Córdoba).",
    cta: "Ver FAPD",
    portal: true,
  },
  {
    id: "co-2026-agua-dulce",
    titulo: "Provincial Córdoba · agua dulce (consulta FAPD)",
    fecha: "2026-04-01",
    lugar: "Córdoba (según convocatoria)",
