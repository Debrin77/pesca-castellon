...
export const MONTAJES_ESPECIE: MontajeEspecie[] = [
  ...
  {
    id: "currican-costero",
    consejoId: "montaje-currican-costero",
    diagramaId: "montaje-lubina-spinning",
    titulo: "Curricán costero · embarcación",
    resumen: "Línea → emerillón → minnow o cinta a popa a 2–5 kn. Fuera de dársena y de Columbretes.",
    ambito: "costa",
    especieIds: ["lubina", "caballa", "bonito", "palometon", "anjova", "espeton", "jurel"],
    piezas: [
      { tipo: "linea", etiqueta: "Trenza 0.16–0.25", detalle: "según especie" },
      { tipo: "linea", etiqueta: "Bajo fluoro / acero", detalle: "si hay dientes" },
      { tipo: "emerillon", etiqueta: "Emerillón + snap" },
      { tipo: "senuelo", etiqueta: "Minnow / cinta / feathers", detalle: "5–25 m de sonda" },
    ],
    regulacion: [
      "Velocidad 2–5 kn costero; 4–6 kn pelágico (bonito).",
      "No pases por canales de puerto ni reserva Columbretes.",
      "Varía profundidad con plomo de pluma o lip del señuelo.",
    ],
    alternativa: "Spinning embarcado si hay estructura cerca.",
    pasos: [
      "Monta 1–2 líneas a popa con emerillón.",
      "Suelta señuelo y arranca a velocidad constante.",
      "Si hay toque: reduce gas y clava con freno firme.",
    ],
  },
  {
    id: "jigging-barco",
    consejoId: "montaje-jigging-barco",
    diagramaId: "montaje-lubina-spinning",
    titulo: "Jigging / slow jig · embarcación",
    resumen: "Vertical sobre 20–80 m: PE + líder + slow jig. Fondos duros fuera de reserva.",
    ambito: "costa",
    especieIds: ["denton", "pagel", "jurel"],
    piezas: [
      { tipo: "linea", etiqueta: "PE 1.5–3" },
      { tipo: "linea", etiqueta: "Líder fluoro", detalle: "1–2 m" },
      { tipo: "senuelo", etiqueta: "Slow jig 80–200 g", detalle: "según profundidad" },
    ],
    regulacion: [
      "Deja caer al fondo, sube a tirones cortos y deja caer.",
      "Marca el GPS del bajo (waypoint privado).",
      "Confirma que no estás en Columbretes ni dársena.",
    ],
    alternativa: "Fondo con cebo natural si el jig no da toques.",
    pasos: [
      "Fondea o mantén posición sobre el bajo.",
      "Engancha el jig y deja caer controlando la línea.",
      "Trabaja vertical; cambia gramos si la corriente empuja.",
    ],
  },
  {
    id: "sepia-eging",
