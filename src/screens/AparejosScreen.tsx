...
const styles = StyleSheet.create({
  ...
  chipText: { fontSize: 14, color: COLORS.primaryDark, fontWeight: "700", flexShrink: 1 },
  ...
  headerTallaPie: { fontSize: 12, color: "rgba(255,255,255,0.92)", marginTop: 2, maxWidth: 180 },
  headerName: { fontSize: 24, fontWeight: "800", color: "#fff", marginTop: 8, letterSpacing: -0.4 },
  headerScientific: { fontSize: 14, color: "rgba(255,255,255,0.95)", fontStyle: "italic", marginTop: 4 },
  headerBadge: { fontSize: 12, color: "#fff", fontWeight: "800", marginTop: 10, letterSpacing: 0.6 },
  ...
  avisoLegalText: { fontSize: 14, color: "#7a1414", lineHeight: 19, fontWeight: "600" },
  gearCard: {
    backgroundColor: COLORS.surface,
    borderRadius: RADIUS.xl,
    padding: 18,
  ...
  gearAviso: { fontSize: 13, color: COLORS.textMuted, lineHeight: 18, marginBottom: 8 },
  gearRowLabel: { fontSize: 13, fontWeight: "800", color: COLORS.water, marginTop: 14, letterSpacing: 0.4, textTransform: "uppercase" },
  ...
  montajeCtaSub: { fontSize: 14, color: COLORS.textSecondary, marginTop: 4, lineHeight: 18 },
  vocabBox: {
    marginTop: 12,
  ...
  vocabSub: { fontSize: 13, color: COLORS.textSecondary, marginTop: 2, marginBottom: 8 },
