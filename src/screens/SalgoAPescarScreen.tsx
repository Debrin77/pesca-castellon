...
const styles = StyleSheet.create({
  ...
  kicker: { color: "#cfe8db", fontWeight: "800", fontSize: 11, letterSpacing: 0.8, textTransform: "uppercase" },
  title: { color: "#fff", fontSize: 28, fontWeight: "800", marginTop: 4 },
  sub: { color: "#d5ebe0", marginTop: 6, fontSize: 14, lineHeight: 20 },
  ...
  stepOn: { backgroundColor: "rgba(255,255,255,0.28)" },
  stepTxt: { color: "#cfe8db", fontSize: 11, fontWeight: "700" },
  stepTxtOn: { color: "#fff" },
  card: {
