...
const styles = StyleSheet.create({
  ...
  hint: { color: COLORS.textSecondary, fontSize: 14, lineHeight: 19, marginBottom: 12 },
  ...
  origenMeta: { fontSize: 13, color: COLORS.textMuted, fontWeight: "600", marginBottom: 10 },
  ...
  puntoActualTitle: { fontSize: 14, fontWeight: "800", color: COLORS.primary },
  puntoActualMeta: { marginTop: 2, fontSize: 13, color: COLORS.textSecondary, fontWeight: "600" },
  coordsBox: {
    marginTop: 8,
    paddingTop: 8,
    borderTopWidth: 1,
  ...
  formLabel: { fontSize: 13, fontWeight: "700", color: COLORS.textSecondary, marginBottom: 4 },
  input: {
    borderWidth: 1,
    borderColor: COLORS.border,
  ...
  montajeCtaSub: { fontSize: 13, color: COLORS.textSecondary, marginTop: 4, lineHeight: 17 },
  zonaChip: {
    backgroundColor: COLORS.mist,
    borderRadius: RADIUS.md,
    padding: 12,
  ...
  zonaChipMeta: { fontSize: 13, color: COLORS.textSecondary, marginTop: 2, lineHeight: 16 },
});
