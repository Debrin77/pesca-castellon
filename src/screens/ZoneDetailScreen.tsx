...
const styles = StyleSheet.create({
  ...
  accesoMaps: { marginTop: 4, fontSize: 14, fontWeight: '700', color: COLORS.water },
  accesoAviso: { fontSize: 13, color: COLORS.textMuted, marginTop: 4, fontStyle: 'italic' },
  ...
  desc: { fontSize: 14, color: COLORS.textSecondary, lineHeight: 19, marginBottom: 12 },
  avisosBox: {
  ...
  avisosTitle: { fontSize: 14, fontWeight: "800", color: COLORS.warning, marginBottom: 6 },
  avisoItem: { fontSize: 13, color: COLORS.textSecondary, lineHeight: 18, marginBottom: 4 },
  mapLink: {
  ...
  mapLinkTxt: { color: COLORS.waterDark, fontWeight: "800", fontSize: 14 },
  ...
  cardNote: { fontSize: 12, color: COLORS.textMuted, marginTop: 4, fontStyle: "italic", lineHeight: 15 },
  linkText: { fontSize: 13, color: COLORS.water, fontWeight: "600", marginTop: 8 },
  bullet: { fontSize: 13, color: COLORS.textSecondary, marginBottom: 4, lineHeight: 17 },
  ...
  gaugeLabel: { fontSize: 14, fontWeight: "700", color: COLORS.textPrimary, marginTop: 6 },
  equipoBox: {
    marginTop: 10,
    backgroundColor: COLORS.waterLight,
  ...
  equipoTitle: { fontSize: 13, fontWeight: "700", color: COLORS.water, marginBottom: 4 },
  equipoItem: { fontSize: 13, color: "#0d3c5c", marginBottom: 2, lineHeight: 16 },
});
