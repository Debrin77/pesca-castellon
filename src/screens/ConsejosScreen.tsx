...
const styles = StyleSheet.create({
  ...
  introTxt: { marginTop: 4, fontSize: 14, lineHeight: 19, color: COLORS.textSecondary },
  search: {
  ...
  chipTxt: { fontSize: 14, fontWeight: "700", color: COLORS.textSecondary },
  chipTxtOn: { color: "#fff" },
  empty: { textAlign: "center", color: COLORS.textMuted, marginTop: 24, fontSize: 14 },
  section: { marginTop: 14 },
  sectionTitle: { fontSize: 18, fontWeight: "800", color: COLORS.textPrimary },
  sectionSub: { fontSize: 14, color: COLORS.textSecondary, marginBottom: 8, marginTop: 2 },
  card: {
    backgroundColor: COLORS.surface,
    borderRadius: RADIUS.md,
    padding: 14,
  ...
  cardResumen: { fontSize: 14, color: COLORS.textSecondary, marginTop: 2, lineHeight: 18 },
  chevron: { fontSize: 16, color: COLORS.textMuted, fontWeight: "800" },
  cardBody: { marginTop: 10 },
  cardDetalle: { fontSize: 14, color: COLORS.textSecondary, lineHeight: 19, marginTop: 8 },
  ...
  pasoNumTxt: { color: "#fff", fontWeight: "800", fontSize: 13 },
  pasoTxt: { flex: 1, fontSize: 14, lineHeight: 18, color: COLORS.textPrimary, fontWeight: "600" },
  ...
  footnote: { fontSize: 12, color: COLORS.textMuted, lineHeight: 16, marginTop: 16, marginBottom: 8 },
});
