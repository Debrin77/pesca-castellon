...
const styles = StyleSheet.create({
  ...
  saihName: { fontSize: 11.5, fontWeight: "700", color: COLORS.textSecondary },
  saihPct: { fontSize: 18, fontWeight: "800", color: COLORS.waterDark, marginTop: 3 },
  favChip: {
    width: 134,
    backgroundColor: COLORS.surface,
    borderRadius: RADIUS.md,
  ...
  favChipTxt: { fontSize: 12.5, fontWeight: "700", color: COLORS.textPrimary, lineHeight: 16 },
  sinConsulta: {
    fontSize: 13.5,
    color: COLORS.textSecondary,
    lineHeight: 19,
  ...
  mapaCtaTitle: { fontSize: 14.5, fontWeight: "700", color: COLORS.textPrimary },
