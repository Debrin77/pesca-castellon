...
const m = StyleSheet.create({
  ...
  bioPillTxt: { color: "#fff", fontFamily: FONTS.extrabold, fontWeight: "800", fontSize: 14 },
  ...
  chipTxt: { fontSize: 12, fontFamily: FONTS.bold, fontWeight: "700" },
  gaugeOuter: {
    padding: 6,
    borderRadius: 80,
    borderWidth: 1,
  ...
  meteoK: { color: "rgba(255,255,255,0.7)", fontSize: 12, fontFamily: FONTS.semibold },
  meteoV: {
    color: "#fff",
    fontSize: 13,
    fontFamily: FONTS.bold,
  ...
  windowTxt: { color: "#fff", fontFamily: FONTS.bold, fontWeight: "700", fontSize: 13 },
  pintaDisclaimer: {
    marginTop: 10,
  ...
  cupoTxt: { fontSize: 12, color: COLORS.textMuted, fontFamily: FONTS.semibold, marginTop: 4 },
  gpxBtn: {
  ...
  gpxTxt: { color: "#fff", fontFamily: FONTS.extrabold, fontWeight: "800", fontSize: 14 },
  hintMuted: {
    textAlign: "center",
  ...
  stepTxt: { flex: 1, fontFamily: FONTS.semibold, fontSize: 14, color: COLORS.textPrimary },
