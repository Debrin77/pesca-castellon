  ...
  const slides = useMemo(
    () => [
      ...
      },
      {
        ...
        texto:
          "En Inicio ves el pulso del día y «Salgo a pescar» (elige GPS, mapa, coordenadas o zona). El mapa da el veredicto al pulsar un tramo. Aparejos y nudos están a un toque desde Inicio.",
      },
    ],
    [
