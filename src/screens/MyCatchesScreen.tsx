...
const styles = StyleSheet.create({
  ...
  content: { flex: 1 },
  lead: { fontSize: 13, color: COLORS.textSecondary, lineHeight: 18, marginBottom: 12 },
  addButton: {
  ...
  methodBtnPrimaryTxt: { color: "#fff", fontWeight: "700", fontSize: 14 },
  methodBtn: {
    flex: 1,
    borderWidth: 1,
  ...
  methodBtnTxt: { fontWeight: "700", color: COLORS.textSecondary, fontSize: 13 },
  hintMini: { fontSize: 12, color: COLORS.textMuted, marginBottom: 12, lineHeight: 16 },
  coordsOk: { fontSize: 13, color: COLORS.success, fontWeight: "600", marginTop: 8 },
  ...
  secondaryBtnTxt: { color: COLORS.primaryDark, fontWeight: "700", fontSize: 14 },
  formCard: {
    backgroundColor: COLORS.surface,
  ...
  formLabel: { fontSize: 13, fontWeight: "700", color: COLORS.textSecondary, marginBottom: 6, marginTop: 8 },
  input: {
  ...
  emptyText: { fontSize: 14, color: COLORS.textMuted, fontStyle: "italic", lineHeight: 18 },
  card: {
    backgroundColor: COLORS.surface,
    borderRadius: RADIUS.md,
    padding: 0,
  ...
  cardNotas: { fontSize: 13, color: COLORS.textSecondary, marginTop: 4, fontStyle: "italic" },
  verMapaHint: { fontSize: 12, color: COLORS.primary, fontWeight: "600", marginTop: 6 },
  ...
  photoBtnTxt: { fontWeight: "700", color: COLORS.textSecondary, fontSize: 13 },
  gpxBtn: {
    backgroundColor: COLORS.water,
    borderRadius: RADIUS.md,
    paddingVertical: 12,
  ...
  gpxSub: { color: "rgba(255,255,255,0.9)", fontSize: 12, marginTop: 4, textAlign: "center" },
  toolsBox: {
    marginBottom: 14,
    gap: 8,
  },
  toolsTitle: { fontSize: 13, fontWeight: "800", color: COLORS.textMuted, letterSpacing: 0.4, marginBottom: 4 },
  cupoBox: {
    backgroundColor: COLORS.mist,
    borderRadius: RADIUS.md,
    padding: 12,
  ...
  cupoTitle: { fontWeight: "800", color: COLORS.textPrimary, fontSize: 14 },
  cupoWarn: { color: COLORS.danger, fontSize: 13, fontWeight: "700", marginTop: 6 },
  cupoMeta: { color: COLORS.textSecondary, fontSize: 12, marginTop: 4, lineHeight: 16 },
  fotoPreview: {
    width: "100%",
    height: 160,
    borderRadius: RADIUS.sm,
