...
const styles = StyleSheet.create({
  ...
  headerSubtitle: { color: "#dfeee5", fontSize: 14, marginTop: 4, textAlign: "center" },
  resumen: { fontSize: 14, color: COLORS.textPrimary, marginBottom: 8, lineHeight: 20 },
  vigencia: { fontSize: 12, color: COLORS.textMuted, marginBottom: 14, lineHeight: 16, fontStyle: "italic" },
  card: {
  ...
  cardText: { fontSize: 14, color: COLORS.textSecondary, lineHeight: 18 },
  link: { fontSize: 14, fontWeight: "700", color: COLORS.primary, marginTop: 10 },
  ambitoBlock: {
    marginBottom: 12,
    paddingBottom: 10,
    borderBottomWidth: 1,
  ...
  ambitoTitulo: { fontSize: 14, fontWeight: "800", color: COLORS.primaryDark },
  ambitoDonde: { fontSize: 13, color: COLORS.waterDark, fontWeight: "700", marginTop: 2, marginBottom: 4 },
  privacy: { fontSize: 13, color: COLORS.textMuted, lineHeight: 17, marginBottom: 10 },
  ...
  licTipo: { fontSize: 14, fontWeight: "800", color: COLORS.textPrimary },
  licMeta: { fontSize: 13, color: COLORS.textSecondary, marginTop: 2 },
  licEstado: { fontSize: 13, fontWeight: "800", marginTop: 2 },
  borrarBtn: { paddingHorizontal: 10, paddingVertical: 6 },
  borrarTxt: { color: COLORS.danger, fontWeight: "700", fontSize: 13 },
  formLabel: {
    fontSize: 13,
    fontWeight: "700",
  ...
  tipoChipTxt: { fontSize: 13, fontWeight: "700", color: COLORS.textSecondary },
  ...
  bullet: { fontSize: 14, color: COLORS.textSecondary, marginBottom: 4, lineHeight: 18 },
  tallaRow: { marginBottom: 8, paddingBottom: 8, borderBottomWidth: 1, borderBottomColor: COLORS.border },
  tallaName: { fontSize: 14, fontWeight: "700", color: COLORS.textPrimary },
  tallaVal: { fontSize: 13, color: COLORS.textSecondary, marginTop: 2, lineHeight: 17 },
  ctaButton: {
  ...
  ctaTextSecondary: { color: COLORS.primary, fontWeight: "600", fontSize: 14 },
  footnote: { fontSize: 12, color: COLORS.textMuted, marginTop: 14, textAlign: "center", lineHeight: 16 },
});
