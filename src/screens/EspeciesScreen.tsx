...
const styles = StyleSheet.create({
  ...
  modoTxt: { fontSize: 14, fontWeight: "700", color: COLORS.textSecondary, textAlign: "center" },
  modoTxtOn: { color: "#fff" },
  ...
  hint: { fontSize: 13, color: COLORS.textSecondary, lineHeight: 17, textAlign: "center", marginTop: 4 },
  ctaOrilla: {
    marginTop: 10,
    minHeight: 48,
    borderRadius: RADIUS.md,
