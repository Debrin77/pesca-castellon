...
export function aplicarEstilosWeb() {
  ...
  font.rel = "stylesheet";
  font.href =
    "https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,600;9..144,700&family=Literata:opsz,wght@7..72,600;7..72,700&family=Source+Sans+3:wght@400;600;700;800&display=swap";
  ...
  style.textContent = `
    ...
    .pesca-brand {
      font-family: "Literata", "Fraunces", Georgia, serif;
      font-optical-sizing: auto;
    }
    .pesca-pin--selected {
